...
After multiple commits/tags and before pushing a release tag to a remote repository like *GitHub*, we need to document our changes into `CHANGELOG.md` file using the following command:
