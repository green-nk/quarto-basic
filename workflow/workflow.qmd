...
Of course, you also want to skip commits for `CHANGELOG.md` as it will be automatically created to the release before publishing. To do this adding specific commits by their SHA1 value in the `.cliffignore` file.
